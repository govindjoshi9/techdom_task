...
const LoanCard = ({ loan, onApprove, isAdmin }) => {
    ...
    <div className="bg-white shadow-md rounded-lg p-6 mb-4">
      ...
      {isExpanded && (
        <div className="mt-4">
          ...
          {/* Check if scheduledRepayments exists and is an array */}
          {loan.scheduledRepayments && loan.scheduledRepayments.length > 0 ? (
            ...
            <p className="text-gray-500">No scheduled repayments available.</p>
          )}
